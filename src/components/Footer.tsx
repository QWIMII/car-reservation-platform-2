    ...
    <footer className="bg-black text-white py-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-400">
              ...
              Мы предлагаем широкий выбор роскошных автомобилей для любых целей.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/profile" className="text-gray-400 hover:text-white transition-colors">Личный кабинет</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>Москва, ул. Тверская, 21</li>
              <li>+7 (495) 123-45-67</li>
              <li>info@meowest.ru</li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} MEOWEST. Все права защищены.</p>
        </div>
      </div>
    </footer>
  );
